...
//#define IPFIJA 1  //PONER para IP Fija

#ifdef IPFIJA
IPAddress ip(192, 168, 1, 121); // this 3 lines for a fix IP-address
...
void setup() {
  ...
  delay(100);
  #ifdef IPFIJA
  WiFi.config(ip, gateway, subnet); // PARA IP FIJA -->before or after Wifi.Begin(ssid, password);
  #endif
...
void loop() {
  ...
  while (client.connected()) {
    if(client.available()) {
      ...
      MBHoldingRegister[0] = 0;//random(0,12);
      MBHoldingRegister[1] = 1;//random(0,12);
      MBHoldingRegister[2] = 2;//random(0,12);
      MBHoldingRegister[3] = 3;//random(0,12);
      MBHoldingRegister[4] = 4;//random(0,12);
      MBHoldingRegister[5] = 5;//random(0,12);
      MBHoldingRegister[6] = 6;//random(0,12);
      MBHoldingRegister[7] = 7;//random(0,12);
      MBHoldingRegister[8] = 8;//random(0,12);
      MBHoldingRegister[9] = 9;//random(0,12);
